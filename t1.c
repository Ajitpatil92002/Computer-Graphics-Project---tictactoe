...
void drawxo()
{
	for(int i = 0; i <= 2; i++)
	{
		for(int j = 0; j <= 2; j++)
		{
			...
			{
				glBegin(GL_LINES);
                glVertex2f(50 + j * 100 - 50, 100 + i * 100 - 50);
                glVertex2f(50 + j * 100 + 50, 100 + i * 100 + 50);
                glVertex2f(50 + j * 100 - 50, 100 + i * 100 + 50);
                glVertex2f(50 + j * 100 + 50, 100 + i * 100 - 50);
				glEnd();
			...
			else if(matrix[i][j] == 2) //if it is 2 then draw o
			{
                ...
                glVertex2f(50 + j * 100 + 25, 100 + i * 100 + 25);
                glVertex2f(50 + j * 100 + 25, 100 + i * 100 - 25);
                glVertex2f(25 + j * 100 + 25, 50 + i * 100 - 25);
				glEnd();
			}
		}
	}
...
void display()
{
	...
	glColor3f(0, 0, 0);
	if(playerturn == 1)
		drawString(GLUT_BITMAP_HELVETICA_18, "Player1 turn", 100, 30);
	else
		drawString(GLUT_BITMAP_HELVETICA_18, "Player2 turn", 100, 30);
